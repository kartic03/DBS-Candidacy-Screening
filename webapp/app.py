...
def generate_groq_report(disease_duration, updrs3_total, hoehn_yahr, total_asym,
    ...
    try:
        ...
        system_prompt = (
            ...
            "Format: [DBS_Score][Motor_Profile][Key_Drivers][Suggested_Next_Step][Caution_Flags]. "
            "Under Suggested_Next_Step, describe only assessment or follow-up actions, for example "
            "specialist review, repeat assessment interval, or further work-up. Never state or imply "
            "that the patient is or is not a DBS candidate, never recommend surgery, and never name "
            "a stimulation target such as STN or GPi. "
