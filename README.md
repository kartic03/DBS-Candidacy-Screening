...
| GaitPDB (exploratory, PD vs control) | 165 | Gait force plates (100 Hz) | XGBoost | 0.988 | 5-fold CV |
| UCI Voice (exploratory, PD vs control) | 195 | Acoustic voice features | MLP | 0.972 | 5-fold CV |
